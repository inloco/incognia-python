...
class TestTokenManager(TestCase):
    ...
    SHORT_EXPIRATION_TOKEN_VALUES: Final[TokenValues] = TokenValues('S_E_ACCESS_TOKEN', 'S_E_TOKEN_TYPE')
    SHORT_EXPIRATION_JSON_POST_RESPONSE: Final[dict] = {
        'access_token': 'S_E_ACCESS_TOKEN',
        'token_type': 'S_E_TOKEN_TYPE',
        'expires_in': 5
    }
    CLIENT_ID_AND_SECRET_ENCODED: Final[str] = base64.urlsafe_b64encode(f'{CLIENT_ID}:{CLIENT_SECRET}'
